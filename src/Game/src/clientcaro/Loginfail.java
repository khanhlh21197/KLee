...
public class Loginfail extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bntYes = new javax.swing.JButton();
        ...
        bntYes.setFont(new java.awt.Font("Tahoma", 3, 11)); // NOI18N
        bntYes.setText("Yes");
        bntYes.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bntYesActionPerformed(evt);
            }
        });

        bntNo.setFont(new java.awt.Font("Tahoma", 3, 11)); // NOI18N
        bntNo.setText("No");
    ...
    private void bntYesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntYesActionPerformed
        // TODO add your handling code here:
         Register register = new Register(inFromServer, outToServer);
         setVisible(false);
         
    }//GEN-LAST:event_bntYesActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton bntNo;
    private javax.swing.JButton bntYes;
