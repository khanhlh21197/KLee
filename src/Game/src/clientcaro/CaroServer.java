...
import servercaro.ScoresDAO;
import servercaro.MatchesDAO;
...
public class CaroServer extends javax.swing.JFrame {
    ...
    public CaroServer(int _portserver1, int _portserver2, String name) {
        ...
        System.out.println("Server"+username);
                ...
                MatchesDAO m = new MatchesDAO();
                int matches = m.getMatches(username);
                matches++;
                m.setMatches(matches, username);
...
//        createTrayIcon();
    ...
    private void initComponents() {
        ...
        jCountdown = new javax.swing.JLabel();
        ...
        myselfPanel.setBackground(new java.awt.Color(255, 102, 102));
        ...
        jLabel_ban.setBackground(new java.awt.Color(255, 51, 255));
        ...
        youPanel.setBackground(new java.awt.Color(255, 255, 51));
        ...
        jCountdown.setText("Time Remaining: ");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jCountdown, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                while(time > 0){
                    ...
                    jCountdown.setText("Time remaining: "+time);
                }
                if(time == 0){
                    isPause = true;
//                    JOptionPane.showMessageDialog(rootPane, "You lose!");z
...
//            countdowntimer();
            ...
            try {
                    ...
                    IOFile.out(currentColumn + "-" + currentRow, "outServer.txt");
        ...
        if (!checked.contains(p)) {
            ...
            if (isWin(true)) {
                ...
                startUser = false;
                ScoresDAO d = new ScoresDAO();
                int diem = d.getdiem(username);
                diem++;
                d.setdiem(diem, username);
...
//            return false;       
    ...
    private javax.swing.JLabel jCountdown;
